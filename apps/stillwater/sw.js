...
// phone. No backend here, so this deliberately does NOT try to do push
// notifications — Stillwater has no reminders to push in the first place.

const CACHE_NAME = "stillwater-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
