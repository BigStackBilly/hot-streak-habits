...
// phone. No backend here, so this deliberately does NOT attempt push
// notifications — Fuseday has no reminder mechanic to begin with.

const CACHE_NAME = "fuseday-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
